...
dict_dir = os.path.join(current_dir, 'asset/dict')
words_dir = os.path.join(current_dir, 'asset/words')
clipboard_dir = os.path.join(current_dir, 'asset/clipboard')
words_index_file = os.path.join(current_dir, 'asset/dict/words_index.json')   # index file
