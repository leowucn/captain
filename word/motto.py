...
def get_random_motto():
	...
	try:
		...
		res_lst.append('Religious')
		res_lst.append('"I know God won’t give me anything I can’t handle. I just wish he didn’t trust me so much."')
		res_lst.append('Mother Teresa')
	return res_lst
